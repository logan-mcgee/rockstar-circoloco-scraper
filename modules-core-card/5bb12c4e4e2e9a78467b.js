  ...
  [427], {
    ...
    1204: (e, a, t) => {
      ...
      const {
        ...
        const [C, T] = (0, n.useState)(f?.size ?? p), {
          parent: j,
          main: w,
          thumbs: S
    ...
    4427: (e, a, t) => {
      ...
      const v = e => {
        ...
        g = {
          clrCardModalContent: "de3a11886ff7c7c01a80",
          expandedCard: "e1a0223a78c9aa470ef6",
          content: "d104d01f2048b62b51d8",
          details: "cc5da9e77f92def47e14",
          calloutHeaders: "ac6438a76bed0e28cf70"
        },
        {
          variants: f
        } = d.framer.Animations,
        x = e => {
          ...
          const x = (0, c.useTinaPayload)(),
            y = v?.payload?.meta?.cdn ?? x?.meta?.prod ?? !1,
            k = {
              image: o
            };
          return console.log("image", k), (0, p.jsx)(m.Z, {
            id: a,
            title: n,
            context: "clr-card",
            size: r,
      ...
      function b(e, a) {
        ...
        return r().forOwn(e, ((e, n) => {
          ...
          } else r().isObject(e) && !r().isArray(e) ? b(e, a) : r().isArray(e) && (t[n] = e.map((e => r().isObject(e) ? b(e, a) : e)))
        })), t || []
      }
      const N = e => {
        let {
        ...
        const n = (0, c.useTinaComponents)(),
          ...
          l = (() => {
            const {
              data: e
            } = (0, y.useQuery)(k.TinaModulesList, {
              variables: {
                type: "clr-card",
                locale: "en_us"
              }
          ...
          m = (0, c.useTinaPayload)(),
          u = (0, i.useMemo)((() => l ? l.reduce(((e, a) => {
            if (a) {
              const {
                id: t,
                tina: n
              ...
              const d = i?.payload,
                l = d?.meta?.cdn ?? !1 ?? m?.meta?.prod ?? !1,
                o = b(d?.content?.[0], l),
                u = d?.meta?.title,
                v = o?._memoq?.subheader,
                h = o?.image,
                g = "short",
                f = o?.content ?? [];
